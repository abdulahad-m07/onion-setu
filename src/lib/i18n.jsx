...
const dict = {
  ...
  hi: f({
    ...
    welcomeBack:"वापसी पर स्वागत है", welcomeCreate:"अपना बनाएं", onionSetu:"ओनियनसेतु", gmailOrPhone:"जीमेल या फोन नंबर", password:"पासवर्ड", fullName:"पूरा नाम", villageCenter:"गाँव / केंद्र",
    sendOtp:"OTP भेजें", verifyOtp:"OTP सत्यापित करें", resendOtp:"OTP पुनः भेजें", enterOtp:"6-अंकों का OTP दर्ज करें", demoAccounts:"डेमो खाते", quickLogin:"त्वरित लॉगिन", noAccount:"खाता नहीं है?", haveAccount:"पहले से खाता है?",
    myAssessments:"मेरे मूल्यांकन", allAssessments:"सभी मूल्यांकन", todaysAssessments:"आज के मूल्यांकन", gradeAPercent:"ग्रेड A %", humanReviews:"मानव समीक्षा", pendingDisputes:"लंबित विवाद", recentAssessments:"हाल के मूल्यांकन", activity:"गतिविधि", howItWorks:"कैसे काम करता है",
    qualityReports:"गुणवत्ता रिपोर्ट", reportId:"रिपोर्ट आईडी", date:"तारीख", location:"स्थान", policyVersion:"नीति संस्करण", gradeA:"ग्रेड A %", urs:"URS %", confidence:"विश्वास", farmerAck:"किसान स्वीकृति", graderAck:"ग्रेडर स्वीकृति", disputeStatus:"विवाद स्थिति",
    sampleSize:"नमूना आकार", lotId:"लॉट आईडी", hash:"हैश (SHA-256)", uploadedImages:"अपलोड की गई तस्वीरें", perOnionResults:"प्रति प्याज परिणाम", downloadInSelected:"डाउनलोड करें", downloadInEnglish:"अंग्रेजी में डाउनलोड", qrVerify:"QR सत्यापन", openVerification:"सत्यापन खोलें",
    gradingPolicy:"ग्रेडिंग नीति", sizeBand:"आकार सीमा", defectTolerances:"दोष सहनशीलता", offlineSync:"ऑफलाइन और सिंक", system:"सिस्टम", languageSettings:"भाषा", changeLanguage:"भाषा बदलें",
    myFarm:"मेरा खेत — ग्रेडिंग अवलोकन", procOverview:"AI-सहायित खरीद अवलोकन", newAssessmentTitle:"नया मूल्यांकन", farmerGraderSession:"किसान + ग्रेडर संयुक्त सत्र · AI सहायता, मानव निर्णय",
    storedReportData:"संग्रहीत रिपोर्ट डेटा", finalReport:"अंतिम रिपोर्ट", viewOf:"दृश्य", withRef:"25mm संदर्भ के साथ", storedIn:"सुपाबेस स्टोरेज में संग्रहीत", demoPlaceholder:"डेमो प्लेसहोल्डर",
    acknowledged:"स्वीकृत ✓", pending:"लंबित", noDispute:"कोई विवाद नहीं", underReview:"समीक्षाधीन", disputed:"विवादित", generatePdf:"PDF बनाएं · प्रिंट", markAck:"स्वीकृति दर्ज करें", flagReview:"रिपोर्ट फ्लैग करें", verification:"सत्यापन", reportVerified:"रिपोर्ट सत्यापित",
    appName:"ओनियनसेतु", appSubtitle:"AI-सहायित ग्रेडिंग",
  }),
