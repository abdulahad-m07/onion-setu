...
export const assessmentsSeed = [
  {
    ...
    sampleSize:100, gradeA:50, gradeB:18, gradeC:12, gradeReject:20, urs:22, status:"Completed", sync:"Synced", acceptance:"Accepted",
    humanReviews:3, confidence:84,
    onions: demoOnions,
    hash:"a3f9c1e78b2d4f0a9e11d6c3a5b8e902",
  ...
  },
  {
    ...
    policyVersion:"v2026.1", modelVersion:"Prototype Demo Inference",
    sampleSize:50, gradeA:40, gradeB:20, gradeC:20, gradeReject:20, urs:35, status:"Human Review", sync:"Synced", acceptance:"Accepted",
    humanReviews:2, confidence:47,
    onions: demoOnions.slice(0,5),
    hash:"71b0e4d2c9a84f33b1e08f2a9c6d3e11",
  ...
  },
  {
    ...
    sampleSize:50, gradeA:45, gradeB:20, gradeC:15, gradeReject:20, urs:18, status:"Completed", sync:"Synced", acceptance:"Rejected",
    humanReviews:1, confidence:92,
    onions: demoOnions.slice(0,5),
    hash:"c4e9b1a02f884d1aa7729e0b3c5d6f01",
    acknowledged:{ farmer:true, grader:true },
  },
  {
    ...
    policyVersion:"v2026.1", modelVersion:"Prototype Demo Inference",
    sampleSize:50, gradeA:55, gradeB:15, gradeC:10, gradeReject:20, urs:25, status:"Human Review", sync:"Synced", acceptance:"Accepted",
    humanReviews:4, confidence:55,
    onions: demoOnions.slice(0,5),
    hash:"e8f1a2c39b0d4c778a113f6e9d2b5c44",
  ...
  },
  {
    ...
    policyVersion:"v2026.1", modelVersion:"Prototype Demo Inference",
    sampleSize:30, gradeA:30, gradeB:20, gradeC:20, gradeReject:30, urs:40, status:"Sync Pending", sync:"Offline", acceptance:"Accepted",
